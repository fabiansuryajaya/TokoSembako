...
<script>
    ...
    $(document).ready(function () {
            ...
            try {
                ...
                result.data.forEach(restock => {
                    ...
                    tr.innerHTML = `
                        ...
                        <td>${restock.total_jumlah}</td>
                        <td>${formatCurrencyIDR(1 * restock.total_pembelian)}</td>
                    `;
        ...
        document.getElementById('export_excel_btn').addEventListener('click', function() {
            // export reportTable
            let tableHTML = '<table border="1"><tr><th>Tanggal</th><th>Nama Produk</th><th>Nama Supplier</th><th>Jumlah Restock</th></tr>';
